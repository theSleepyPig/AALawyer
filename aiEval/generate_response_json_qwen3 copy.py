#+similar cases
# nohup python /home/yxma/hzx/LeLLM/aiEval/generate_response_json_qwen3.py \
#     > generate_response_json_qwen3.log 2>&1 &
import csv
import json
import re
import os
...
output_json = "results/generated_200_qwen3.json"  # 改为 json 输出
...
def generate_response(prompt):
    ...
    text = tokenizer.apply_chat_template(
        ...
        # Qwen3 的官方示例中使用了 enable_thinking=False，这里也保留
    ...
    # 4. Qwen3 特有的 <|endofthink|> 标签解析逻辑
    #    从 evabqwen3.py 中复制，确保正确提取最终答案
    try:
