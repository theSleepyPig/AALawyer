#+similar cases
# nohup python /home/yxma/hzx/hzx/LeLLM/aiEval/generate_response_json_disc7b.py \
#     > generate_response_json_disc.log 2>&1 &
import csv
import json
import re
import os
...
output_json = "results/generated_200_disc2.json"  # 改为 json 输出
