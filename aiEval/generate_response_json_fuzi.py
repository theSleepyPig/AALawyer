#+similar cases
# nohup python /home/yxma/hzx/hzx/LeLLM/aiEval/generate_response_json_fuzi.py \
#     > generate_response_json_fuzi.log 2>&1 &
import csv
import json
import re
import os
...
output_json = "results/generated_200_fuzi.json"  # 改为 json 输出

results = []

# model_path = "/mnt/ssd_2/yxma/LeLLM/train_mergem20"
model_path = "/mnt/ssd_2/yxma/LeLLM/Fuzi-Mingcha-6B"
