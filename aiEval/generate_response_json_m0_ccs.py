...
output_json = "results/generated_200_m0_v2_ccs.json"  # 改为 json 输出
...
for idx, item in enumerate(tqdm(data, desc="Generating answers:")):
    ...
    # response_law_numbers = clean_think_tags(generate_response(prompt_law))
    ...
    # response_no_rag = clean_think_tags(generate_response(prompt_no_rag))
    ...
    # response_aa = clean_think_tags(generate_response(prompt_aa))
    ...
    # response_with_case = clean_think_tags(generate_response(prompt_rag))
