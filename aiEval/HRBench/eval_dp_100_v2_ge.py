...
if not api_key:
    # 如果没有设置环境变量，请将你的 API Key 直接填在这里
    # api_key = "YOUR_GEMINI_API_KEY"
    print("错误：请先设置名为 'GEMINI_API_KEY' 的环境变量。")
    # 你也可以直接在这里填入你的 API Key
    # genai.configure(api_key="YOUR_GEMINI_API_KEY")
    # 或者直接退出
    # return
genai.configure(api_key=api_key)

# 这里你可以根据需要选择不同的 Gemini 模型
...
def get_score(prompt):
    try:
        # Gemini API 使用 generate_content 方法
...
# ✅ 示例调用
evaluate_to_csv("results/generated_200_m20_v2.json", "results/eval_scores_m20_200_4dim_v2_gemini.csv")
