# nohup python /home/yxma/hzx/hzx/LeLLM/LLaMA-Factory/a/evab_api.py \
#     --experiment_id deepseekv3 \
#     --device 1 \
#     --mode zero_shot \
#     --max_new_tokens 2048 \
...
def generate_response(prompt):
    messages = [
        {"role": "system", "content": "You are a legal assistant skilled at citing accurate law."},
        {"role": "user", "content": prompt}
    ]
    try:
        response = client.chat.completions.create(
            model="deepseek-chat",  # 改为你的模型名，如 deepseek-v2-chat
            messages=messages,
            temperature=0.2,
