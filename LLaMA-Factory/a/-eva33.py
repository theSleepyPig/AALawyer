# python a/eva33.py
# nohup python a/eva33.py > eva33m12.log 2>&1 &
...
wandb.init(project=f"-Test-{experiment_id}", entity='xuan_LeLLM', reinit=True)
...
json_file_path = "/home/yxma/hzx/hzx/LeLLM/LawBench/data/zero_shot/3-3.json"
...
def test_model_from_json(json_file_path, output_folder):
    ...
    # 生成输出文件路径
    output_file_path = os.path.join(output_folder, "3-3.json")
