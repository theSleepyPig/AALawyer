# nohup python /home/yxma/hzx/LeLLM/LLaMA-Factory/a/evabinter.py \
#     --experiment_id inter \
#     --device 0 \
#     --mode zero_shot \
#     --max_new_tokens 2048 \
#     > evabash_zero_shot_inter.log 2>&1 &
...
if args.experiment_id == "m0":
    ...
    model_path = f"/mnt/ssd_2/yxma/LeLLM/internlm3-8b-instruct/"
    # "/mnt/ssd_2/yxma/LeLLM/internlm3-8b-instruct/"
...
model = AutoModelForCausalLM.from_pretrained(
    ...
    device_map=device_map_setting # ✅ 使用这个自动映射
)
...
json_base_path = f"/home/yxma/hzx/LeLLM/LawBench/data/{args.mode}/"
output_base_folder = f"/home/yxma/hzx/LeLLM/ckpt/predictions/{args.mode}/output_results_{args.experiment_id}"
