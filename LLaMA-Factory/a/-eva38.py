# python a/eva38.py
# nohup python a/eva38.py > eva38m12.log 2>&1 &
...
# para
experiment_id = "m10"
device_map_setting = {"": 1} 
# device_map_setting = {0: 1, 1: 2}


wandb.init(project=f"-Test-{experiment_id}-38", entity='xuan_LeLLM', reinit=True)
...
json_file_path = "/home/yxma/hzx/hzx/LeLLM/LawBench/data/zero_shot/3-8.json"
...
def test_model_from_json(json_file_path, output_folder):
    ...
    # 生成输出文件路径
    output_file_path = os.path.join(output_folder, "3-8.json")
