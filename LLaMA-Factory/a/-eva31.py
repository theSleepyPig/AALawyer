...
import wandb
wandb.init(project='-Test-m12', entity='xuan_LeLLM', reinit=True)
...
# 预训练过法条数据-1epoch
model_path = "/mnt/ssd_2/yxma/LeLLM/train_mergem12/"
print(model_path)
...
model = AutoModelForCausalLM.from_pretrained(
    model_path,
    torch_dtype="auto",
    device_map={"": 2}  # 这里指定单卡 cuda:0
    # device_map="auto"
)
tokenizer = AutoTokenizer.from_pretrained(model_path)

# 示例：指定 JSON 文件路径和输出文件夹
json_file_path = "/home/yxma/hzx/hzx/LeLLM/LawBench/data/zero_shot/3-1.json"
output_folder = "/home/yxma/hzx/hzx/LeLLM/ckpt/predictions/zero_shot/output_results_m12"  # +all article pretrain
print(output_folder)
...
def test_model_from_json(json_file_path, output_folder):
    """
    ...
    # 生成输出文件路径
    output_file_path = os.path.join(output_folder, "3-1.json")
...
# 运行测试
test_model_from_json(json_file_path, output_folder)
