...
# m23
nohup bash -c "CUDA_VISIBLE_DEVICES=1,2,3 llamafactory-cli train \
    --stage sft \
    --do_train True \
    --model_name_or_path /mnt/ssd_2/yxma/LeLLM/train_mergem12 \
    --preprocessing_num_workers 16 \
    ...
    --report_to wandb \
    --run_name train_m23 \
    --output_dir /mnt/ssd_2/yxma/LeLLM/ckpt/train_m23 \
    --bf16 True \
    --plot_loss True \
    --trust_remote_code True \
    --ddp_timeout 180000000 \
    ...
    --lora_alpha 16 \
    --lora_dropout 0 \
    --lora_target all" > train_m23.log 2>&1 &