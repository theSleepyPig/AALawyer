# nohup python /home/yxma/hzx/LeLLM/LLaMA-Factory/a/evabdisc13b.py \
#     --experiment_id disc13b \
#     --device 2 \
#     --mode zero_shot \
#     --max_new_tokens 2048 \
#     > evabash_zero_shot_disc13b.log 2>&1 &
...
parser.add_argument("--device", type=str, default="2", help="CUDA device(s) to use, e.g., '0' or '0,1,2'")
...
if args.experiment_id == "m0":
    ...
    model_path = f"/mnt/ssd_2/yxma/LeLLM/DISC-LawLLM"
...
def generate_response(prompt):
    # ✅ 手动拼接多轮对话格式
    text = (
        "你是LawLLM，一个由复旦大学DISC实验室创造的法律助手。\n"
        f"用户：{prompt}\n"
        "助手："
    )
