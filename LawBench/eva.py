...
import wandb
wandb.init(project='-Test-m0', entity='xuanzhu_07-university-of-sydney', reinit=True)
...
# 预训练过法条数据-1epoch
# model_path = "/mnt/ssd_2/yxma/LeLLM/train_mergem10/"
...
output_folder = "/home/yxma/hzx/hzx/LeLLM/ckpt/output_results_m0"  # +all article pretrain
...
def test_model_from_json(json_file_path, output_folder):
    ...
    # 生成输出文件路径
    output_file_path = os.path.join(output_folder, "output_results.json")
